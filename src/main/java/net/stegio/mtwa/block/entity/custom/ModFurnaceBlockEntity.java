...
public abstract class ModFurnaceBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider {
    protected static final int MODINPUT_SLOT_INDEX1 = 11;
    protected static final int MODINPUT_SLOT_INDEX2 = 21;
    protected static final int MODINPUT_SLOT_INDEX3 = 31;
    protected static final int MODINPUT_SLOT_INDEX4 = 41;
    protected static final int MODINPUT_SLOT_INDEX5 = 51;
    protected static final int MODINPUT_SLOT_INDEX6 = 61;
    protected static final int MODINPUT_SLOT_INDEX7 = 71;
    protected static final int MODINPUT_SLOT_INDEX8 = 81;
    protected static final int MODINPUT_SLOT_INDEX9 = 91;
    protected static final int MODFUEL_SLOT_INDEX = 1;
    ...
    protected final PropertyDelegate propertyDelegate = new PropertyDelegate() {
        ...
        public int get(int index) {
            switch (index) {
                case 0:
                    return ModFurnaceBlockEntity.this.burnTime;
                case 1:
                    return ModFurnaceBlockEntity.this.fuelTime;
                case 2:
                    return ModFurnaceBlockEntity.this.cookTime;
                case 3:
                    return ModFurnaceBlockEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0:
                    net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity.this.burnTime = value;
                    break;
                case 1:
                    net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity.this.fuelTime = value;
                    break;
                case 2:
                    net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity.this.cookTime = value;
                    break;
                case 3:
                    net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity.this.cookTimeTotal = value;
            }
        }
    ...
    protected ModFurnaceBlockEntity(
    ...
    public static void tick(World world, BlockPos pos, BlockState state, net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity blockEntity) {
    ...
    private static int getCookTime(World world, net.stegio.mtwa.block.entity.custom.ModFurnaceBlockEntity furnace) {
