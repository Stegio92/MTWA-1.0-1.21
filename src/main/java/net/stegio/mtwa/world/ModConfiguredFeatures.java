...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> endDebris1 =
                List.of(
                        OreFeatureConfig.createTarget(endReplaceables, ModBlocks.ANCIENT_AETHERITE_DEBRIS1.getDefaultState()));

        List<OreFeatureConfig.Target> endDebris2=
                List.of(
                        OreFeatureConfig.createTarget(endReplaceables, ModBlocks.ANCIENT_TITANITE_DEBRIS1.getDefaultState()));

        List<OreFeatureConfig.Target> endDebris3 =
                List.of(
                        OreFeatureConfig.createTarget(endReplaceables, ModBlocks.ANCIENT_ETERNITE_DEBRIS1.getDefaultState()));

        register(context, ANCIENT_AETHERITE_DEBRIS_KEY1, Feature.ORE, new OreFeatureConfig(endDebris1, 1));
        register(context, ANCIENT_TITANITE_DEBRIS_KEY1, Feature.ORE, new OreFeatureConfig(endDebris2, 1));
        register(context, ANCIENT_ETERNITE_DEBRIS_KEY1, Feature.ORE, new OreFeatureConfig(endDebris3, 1));

        register(context, ANCIENT_AETHERITE_DEBRIS_KEY2, Feature.ORE, new OreFeatureConfig(endDebris1, 2));
        register(context, ANCIENT_TITANITE_DEBRIS_KEY2, Feature.ORE, new OreFeatureConfig(endDebris2, 2));
        register(context, ANCIENT_ETERNITE_DEBRIS_KEY2, Feature.ORE, new OreFeatureConfig(endDebris3, 2));

        register(context, ANCIENT_AETHERITE_DEBRIS_KEY3, Feature.ORE, new OreFeatureConfig(endDebris1, 3));
        register(context, ANCIENT_TITANITE_DEBRIS_KEY3, Feature.ORE, new OreFeatureConfig(endDebris2, 3));
        register(context, ANCIENT_ETERNITE_DEBRIS_KEY3, Feature.ORE, new OreFeatureConfig(endDebris3, 3));
