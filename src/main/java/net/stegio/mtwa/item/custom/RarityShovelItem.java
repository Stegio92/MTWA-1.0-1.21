...
public class RarityShovelItem extends ShovelItem implements CustomRarityHolder {
    private final ModRarity rarity;

    public RarityShovelItem(ToolMaterial toolMaterial, Settings settings, ModRarity rarity) {
