...
public class TitaniteMaceItem extends Item {
    private static final int ATTACK_DAMAGE_MODIFIER_VALUE = 19;
    ...
    public TitaniteMaceItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public static AttributeModifiersComponent createAttributeModifiers() {
        return AttributeModifiersComponent.builder()
                .add(
                        ...
                        new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 19.0, EntityAttributeModifier.Operation.ADD_VALUE),
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        return ingredient.isOf(ModItems.TITANITE_INGOT);
    }
