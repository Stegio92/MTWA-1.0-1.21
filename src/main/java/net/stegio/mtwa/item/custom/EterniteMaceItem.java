...
public class EterniteMaceItem extends Item {
    private static final int ATTACK_DAMAGE_MODIFIER_VALUE = 25;
    ...
    public EterniteMaceItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public static AttributeModifiersComponent createAttributeModifiers() {
        return AttributeModifiersComponent.builder()
                .add(
                        ...
                        new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 25.0, EntityAttributeModifier.Operation.ADD_VALUE),
