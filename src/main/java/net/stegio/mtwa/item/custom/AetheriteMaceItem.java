...
public class AetheriteMaceItem extends Item {
    private static final int ATTACK_DAMAGE_MODIFIER_VALUE = 14;
    ...
    public AetheriteMaceItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        return ingredient.isOf(ModItems.AETHERITE_INGOT);
    }
