...
import net.stegio.mtwa.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.AETHERITE_ARMOR_MATERIAL,
                    ...
                    .put(ModArmorMaterials.AETHERITE_ARMOR_MATERIAL2,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 1, false, false)))
                    .put(ModArmorMaterials.AETHERITE_ARMOR_MATERIAL3,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 1, false, false)))
                    .put(ModArmorMaterials.AETHERITE_ARMOR_MATERIAL4,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 2, false, false)))
                    .put(ModArmorMaterials.AETHERITE_ARMOR_MATERIAL5,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 2, false, false)))
                    .put(ModArmorMaterials.TITANITE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 3, false, false),
                                    new StatusEffectInstance(StatusEffects.STRENGTH, 400, 0, false, false)))
                    .put(ModArmorMaterials.TITANITE_ARMOR_MATERIAL2,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 3, false, false),
                                    new StatusEffectInstance(StatusEffects.STRENGTH, 400, 1, false, false)))
                    .put(ModArmorMaterials.TITANITE_ARMOR_MATERIAL3,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 4, false, false),
                                    new StatusEffectInstance(StatusEffects.STRENGTH, 400, 1, false, false)))
                    .put(ModArmorMaterials.TITANITE_ARMOR_MATERIAL4,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 400, 4, false, false),
                                    new StatusEffectInstance(StatusEffects.STRENGTH, 400, 2, false, false)))
                    .put(ModArmorMaterials.TITANITE_ARMOR_MATERIAL5,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0, false, false),
