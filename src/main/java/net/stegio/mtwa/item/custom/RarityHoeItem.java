...
public class RarityHoeItem extends HoeItem implements CustomRarityHolder {
    private final ModRarity rarity;

    public RarityHoeItem(ToolMaterial toolMaterial, Settings settings, ModRarity rarity) {
