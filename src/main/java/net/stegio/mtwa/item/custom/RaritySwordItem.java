...
public class RaritySwordItem extends SwordItem implements CustomRarityHolder {
    private final ModRarity rarity;

    public RaritySwordItem(ToolMaterial toolMaterial, Settings settings, ModRarity rarity) {
