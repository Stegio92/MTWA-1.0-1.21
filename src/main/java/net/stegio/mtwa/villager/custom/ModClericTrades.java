        ...
        switch (level) {
            ...
            case 2 -> {
                trades.add(new TradeOffer(
                        ...
                        new ItemStack(ModItems.GOLDEN_RYO, 1), 9, 1, 0));
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.GOLDEN_RYO, 1),
                        new ItemStack(ModItems.SILVER_RYO, 16), 9, 1, 0));
            }
            case 3 -> {
                trades.add(new TradeOffer(
                ...
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.GOLDEN_RYO, 1),
                        new ItemStack(ModItems.BRONZE_RYO_BUNDLE, 32), 9, 1, 0));
            }
            case 4 -> {
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.BRONZE_RYO_BUNDLE, 18),
                        new ItemStack(ModItems.SILVER_RYO_BUNDLE, 1), 9, 1, 0));
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.SILVER_RYO_BUNDLE, 1),
                        new ItemStack(ModItems.BRONZE_RYO_BUNDLE, 16), 9, 1, 0));
            }
            case 5 -> {
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.SILVER_RYO_BUNDLE, 18),
                        new ItemStack(ModItems.GOLDEN_RYO_BUNDLE, 1), 9, 1, 0));
                trades.add(new TradeOffer(
                        new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 1),
                        new ItemStack(ModItems.SILVER_RYO_BUNDLE, 16), 9, 1, 0));
            }
        }
        return trades;
    }
