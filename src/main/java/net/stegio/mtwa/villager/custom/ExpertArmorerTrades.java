...
public class ExpertArmorerTrades {
    public static TradeOfferList getTradesForExpertArmorer(int level) {
        ...
        switch (level) {
            ...
            case 3 -> {
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 8), Optional.of(new TradedItem(ModItems.AETHERITE_HELMET2)),
                        new ItemStack(ModItems.AETHERITE_HELMET3, 1), 1, 23, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 10), Optional.of(new TradedItem(ModItems.AETHERITE_CHESTPLATE2)),
                        new ItemStack(ModItems.AETHERITE_CHESTPLATE3, 1), 1, 23, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 9), Optional.of(new TradedItem(ModItems.AETHERITE_LEGGINGS2)),
                        new ItemStack(ModItems.AETHERITE_LEGGINGS3, 1), 1, 23, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 7), Optional.of(new TradedItem(ModItems.AETHERITE_BOOTS2)),
                        new ItemStack(ModItems.AETHERITE_BOOTS3, 1), 1, 23, 0));
            }
            case 4 -> {
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 11), Optional.of(new TradedItem(ModItems.AETHERITE_HELMET3)),
                        new ItemStack(ModItems.AETHERITE_HELMET4, 1), 1, 35, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 13), Optional.of(new TradedItem(ModItems.AETHERITE_CHESTPLATE3)),
                        new ItemStack(ModItems.AETHERITE_CHESTPLATE4, 1), 1, 35, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 12), Optional.of(new TradedItem(ModItems.AETHERITE_LEGGINGS3)),
                        new ItemStack(ModItems.AETHERITE_LEGGINGS4, 1), 1, 35, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 10), Optional.of(new TradedItem(ModItems.AETHERITE_BOOTS3)),
                        new ItemStack(ModItems.AETHERITE_BOOTS4, 1), 1, 35, 0));
            }
            case 5 -> {
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 14), Optional.of(new TradedItem(ModItems.AETHERITE_HELMET4)),
                        new ItemStack(ModItems.AETHERITE_HELMET5, 1), 1, 100, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 16), Optional.of(new TradedItem(ModItems.AETHERITE_CHESTPLATE4)),
                        new ItemStack(ModItems.AETHERITE_CHESTPLATE5, 1), 1, 100, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 15), Optional.of(new TradedItem(ModItems.AETHERITE_LEGGINGS4)),
                        new ItemStack(ModItems.AETHERITE_LEGGINGS5, 1), 1, 100, 0));
                trades.add(new TradeOffer(new TradedItem(ModItems.GOLDEN_RYO_BUNDLE, 13), Optional.of(new TradedItem(ModItems.AETHERITE_BOOTS4)),
