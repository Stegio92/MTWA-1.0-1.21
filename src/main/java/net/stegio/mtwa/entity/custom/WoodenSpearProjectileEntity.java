package net.stegio.mtwa.entity.custom;
...
public class WoodenSpearProjectileEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(WoodenSpearProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(WoodenSpearProjectileEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private boolean dealtDamage;
    public int returnTimer;

    public WoodenSpearProjectileEntity(EntityType<? extends WoodenSpearProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public WoodenSpearProjectileEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.WOODEN_SPEAR, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public WoodenSpearProjectileEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntities.WOODEN_SPEAR, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }
